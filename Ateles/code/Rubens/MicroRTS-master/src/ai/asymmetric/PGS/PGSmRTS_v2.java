 ...
 * @author rubens
 */
public class PGSmRTS_v2 extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public PGSmRTS_v2(UnitTypeTable utt) {
        this(100, -1, 200, 1, 2,
    ...
    public PGSmRTS_v2(int time, int max_playouts, int la, int a_I, int a_R, EvaluationFunction e, UnitTypeTable a_utt, PathFinding a_pf) {
    ...
    * Executa um playout de tamanho igual ao @LOOKAHEAD e retorna o valor
    ...
    @Override
    public AI clone() {
        return new PGSmRTS_v2(TIME_BUDGET, ITERATIONS_BUDGET, LOOKAHEAD, I, R, evaluation, utt, pf);
    }
