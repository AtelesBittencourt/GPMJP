 ...
 * @author ateles
 */
public class POEmRTS_v3 extends AIWithComputationBudget implements InterruptibleAI {
    ...
    public POEmRTS_v3(UnitTypeTable utt) {
        this(100, -1, 200, 1, 2,
    ...
    public POEmRTS_v3(int time, int max_playouts, int la, int a_I, int a_R, EvaluationFunction e, UnitTypeTable a_utt, PathFinding a_pf) {
    ...
    * Executa um playout de tamanho igual ao @LOOKAHEAD e retorna o valor
    ...
    @Override
    public AI clone() {
        return new POEmRTS_v3(TIME_BUDGET, ITERATIONS_BUDGET, LOOKAHEAD, I, R, evaluation, utt, pf);
    }
